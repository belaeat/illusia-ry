...
const ManageItems = () => {
    ...
    const handleSaveEdit = async () => {
        ...
        try {
            const response = await axios.put(`http://localhost:5000/api/items/${editingItem._id}`, editForm);
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg p-6 max-w-md w-full">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Storage Details</label>
                                <input
                                    type="text"
                                    name="storageDetails"
