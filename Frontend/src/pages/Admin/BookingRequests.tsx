...
const BookingRequests = () => {
    ...
    const fetchBookings = async () => {
        try {
            ...
            const response = await fetch('http://localhost:5000/api/booking-requests/admin', {
                headers: {
    ...
    const handleStatusUpdate = async (bookingId: string, newStatus: 'approved' | 'rejected') => {
        try {
            ...
            const response = await fetch(`http://localhost:5000/api/booking-requests/${bookingId}/status`, {
                method: 'PATCH',
                headers: {
                            ...
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <p className="text-gray-600 mt-1">
                                        <span className="font-medium">Requested by:</span> {booking.user.email}
                                    </p>
                                </div>
